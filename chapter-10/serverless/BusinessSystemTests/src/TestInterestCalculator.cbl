      ...
      ******************************************************************
      ...
      $set ilusing (java.util)
       ...
       01 record-bytes                 binary-char occurs 5. 
      ...
      *> Test constants
      ...
      $region Test Configuration
       ...
       write-multiple-records section.
           DECLARE transactions = new ArrayList[binary-char occurs any]. 
           declare transaction-record = type DataClass::GetByteArray  
           ...
           move TEST-TRANSACTION-RECORD to transaction-record
           invoke transactions::add(transaction-record)
           ...
           move TEST-TRANSACTION-RECORD to transaction-record
           invoke transactions::add(transaction-record)
           call SET-TRANSACTION-DATA using by value transactions 
           . 
      $if OESQL-TEST=1
