...
public class WebserviceCustomerTests extends WebserviceApplicationTests {
    ...
    // TODO - Change the value below from 22 to 23 
...
//      TODO Change the value in the statement below from 21 to 22
...
//      TODO Replace the first two when() statements in this method with the 
//      two commented out statements below
//        when().delete(String.format("/service/customer/%d", 
//                CUSTOMER_ID_FOR_DELETION)).then().assertThat()
//                .statusCode(HttpStatus.NO_CONTENT.value());
//
//        when().get(String.format("/service/customer/%d", 
//                CUSTOMER_ID_FOR_DELETION)).then().assertThat()
