...
//    TODO - UNCOMMENT CODE BLOCK UNTIL NEXT END COMMENT
...
//    END
    ...
    public void readLastCustomer() {
        try (CustomerDataAccess cda = new CustomerDataAccess()) {
            ...
            assertTrue(dto != null);
//          TODO - Change 21 to 22 in the following statement
...
//          TODO - Replace 1 in each of the statements below with
//          constant ACCOUNT_ID_FOR_DELETION
            cda.open(AbstractBusinessAccess.OpenMode.rw);
...
//      addAccountToEmpty();
    ...
    public void deleteCustomer() {
        try (CustomerDataAccess cda = new CustomerDataAccess()) {
//          TODO - Replace 1 in each of the statements below with
//          constant CUSTOMER_ID_FOR_DELETION
            cda.open(AbstractBusinessAccess.OpenMode.rw);
